...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || IsArgSet("-?") || IsArgSet("-h") || IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s matrixcoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  matrixcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded matrixcoin transaction") + "\n" +
              "  matrixcoin-tx [options] -create [commands]   " + _("Create hex-encoded matrixcoin transaction") + "\n" +
              "\n";
