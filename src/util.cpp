...
const char * const BITCOIN_CONF_FILENAME = "matrixcoin.conf";
const char * const BITCOIN_PID_FILENAME = "matrixcoin.pid";
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Matrixcoin";
#else
    // Unix
